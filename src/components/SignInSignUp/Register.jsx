...
const Register = () => {
  return (
    <div className="bg-[#EBF4F6] py-10">
      <div className="flex w-full h-screen mx-auto overflow-hidden bg-white rounded-lg shadow-lg dark:bg-gray-800 lg:max-w-5xl">
        <div className="w-full px-6 py-8 md:px-8 lg:w-7/12">
          ...
          <p className="mt-3 text-sm mb-5 text-left text-gray-700 dark:text-gray-200">
            Let's Get started!
          </p>
          <div className="mt-4">
            <label
